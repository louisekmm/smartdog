			...
			<div class="row">
			  <div class="col-md-12 text-center title line-vertical">
				<div class="panel panel-warning">
  				 <div class="panel-heading"><strong>INDIQUE E GANHE</strong></div>
  				   <div class="panel-body">
				<div class="col-md-12 text-center title line-vertical">
				<div class="alert alert-danger fade in" style="display:none;" id="erro">Erro ao gerar o cupom!</div>
				<div class="alert alert-success fade in" style="display:none;" id="ok">Parabéns!! Um cupom foi enviado ao seu e-mail, aproveite!</div>
				<br><h4>Para ganhar um cupom indique o e-mail de 3 amigos nos campos abaixo:<h4>
				<form method="post" class="popup-form" action="amigosenviar.php" enctype="multipart/form-data">	
					<input type="hidden" name="idAdestrador" value="<?=$idAdestrador?>">
					<input type="text" maxlength="50" name="email1" id="email" class="required form-control form-white email emailDiferente" placeholder="E-mail amigo 1" value="">
					<input type="text" name="email2" maxlength="61" id="email" class="required form-control form-white email emailDiferente" placeholder="E-mail amigo 2" value="">
					<input type="text" name="email3" maxlength="61" id="email" class="required form-control form-white email emailDiferente" placeholder="E-mail amigo 3" value="">

					<button type="submit" class="btn btn-lg btn-block btn-amigos" style="background-color: #5cb85c; color:white;">Resgatar Cupom</button>
				</form>
			</div>
			</div>
			</div>
