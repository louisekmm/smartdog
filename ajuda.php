    ...
    <div class="container">
      <div class="row">
        ...
        <div class="panel panel-info">
           <div class="panel-heading"><h4><strong>CENTRAL DE AJUDA</strong></h4></div>
             <div class="panel-body">

              <div class="panel panel-warning">
               <div class="panel-body text-left">
                <h3>Como funciona uma sessão de adestramento?</h3>
                <h4 class="light muted lead" style="padding-bottom:0px; font-size: 18px;">Uma sessão de adestramento é geralmente composta pelo adestrador, o cachorro e o dono do cachorro. Dependendo do problema, as sessões ocorrerão em parques para que o cachorro observe a convivência social ou na sua casa, onde o adestrador observará os costumes da família e aconselhará novos hábitos e comandos para que você os execute durante a semana. Não são usados métodos que prejudiquem os cachorros, adestramento é feito com amor, paciência e postura firme.<br>
                Veja o vídeo abaixo para ter uma ideia melhor de como é uma sessão:<br><br>
                  <div style=" width: 100%; height: auto;" class="text-center">
                    <iframe width="800" height="315" src="https://www.youtube.com/embed/ZI9sUoTUvkE?controls=0"></iframe>
                  </div>
                </h4>
              </div>
            </div>
            ...
            <div class="panel panel-warning">
               <div class="panel-body text-left">
                <h3>Meu cachorro será maltratado?</h3>
                <h4 class="light muted lead" style="padding-bottom:0px; font-size: 18px;">Seu cachorro JAMAIS será maltrado! Usamos apenas reforço positivo, baseado ou não em petiscos. Temos profissionais qualificados para que escolham o melhor método de treinamento sem machucar o seu pet.
                </h4>
              </div>
            </div>
             ...
             <div class="panel panel-warning">
               <div class="panel-body text-left">
                <h3>Posso assistir o adestramento?</h3>
                <h4 class="light muted lead" style="padding-bottom:0px; font-size: 18px;">Não somente pode como deve! Os donos são extremamente incentivados a participar das sessões de adestramento, pois dessa forma conseguem exercer a autoridade de forma correta com seu animal.
                </h4>
              </div>
            </div>
             ...
             <div class="panel panel-warning">
               <div class="panel-body text-left">
                <h3>Meu cachorro ficará apegado ao adestrador?</h3>
                <h4 class="light muted lead" style="padding-bottom:0px; font-size: 18px;">Não! O adestrador auxilia apenas a melhorar certo comportamento do seu cachorro, mas você é o membro da matilha que ele respeita e ama. Dessa forma, o adestrador jamais tomará o lugar de algum membro da família!
                </h4>
              </div>
            </div>
